...
ScrollReveal().reveal('.home-image, .services-container, .portfolio-box, .contact form, .solution-container', {origin: `bottom`});
ScrollReveal().reveal('.home-content h1, .about-image, .skill-left', {origin: `left`});
ScrollReveal().reveal('.home-content p, .about-content h3, .skill-right, .about-content', {origin: `right`});
